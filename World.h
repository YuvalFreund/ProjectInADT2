...
namespace mtm{
    ...
    public:
         ...
         */
        bool check_area_exists(const string& area_name);

        /**
         * checks if a group is in the world
         */
        bool check_clan_exists(const string& clan_name);
        const bool check_clan_exists(const string& clan_name) const;

        /**
         * checks if a group is in the world
         */
        bool check_group_exists(const string& group_name);
        const bool check_group_exists(const string& group_name) const;
    };
